...
import { catchError, Observable, BehaviorSubject, of, switchMap, throwError } from 'rxjs';
...
export interface DecodedToken {
    ...
    role_id: number | null; // ID del doctor o paciente
    iat: number;
    exp: number;
}
...
export class AuthService {
    ...
    signIn(credentials: { email: string; password: string }): Observable<AuthResponse> {
        ...
        return this._httpClient.post<AuthResponse>(`${this.apiUrl}/login`, credentials).pipe(
    ...
    signInUsingToken(): Observable<any> {
        ...
        return this._httpClient
            .post(`${this.apiUrl}/login-with-token`, {
